...
<head>
  ...
  <title>Sibusiso Ndlovu - Software Developer and Website Designer</title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="HandheldFriendly" content="true">
  <meta name="author" content="sbundlovu" >
			...
			<div class="centrize full-width">
				<div class="vertical-center">
					<div class="spinner-logo">
						<img src="assets/images/logo2.png" alt="Sibusiso Ndlovu - Software Developer and Website
						Designer in Pretoria" >
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											...
											<div class="menu-full">
												<ul class="menu-full">
													...
													<li class="menu-item">
														<a class="splitting-text-anim-2" data-splitting="chars"
                                                           href="#services-section">What I Do</a>
													</li>
													<li class="menu-item">
														<a class="splitting-text-anim-2" data-splitting="chars"
                                                           href="#skills-section">My Skill Set</a>
													</li>
													<li class="menu-item">
														<a class="splitting-text-anim-2" data-splitting="chars"
                                                           href="#works-section">What I Have Built</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a class="splitting-text-anim-2" data-splitting="chars"
                                                           href="#contact-section">Contact Me</a>
													</li>
												</ul>
											</div>
											...
											<div class="menu-social-links">
												<a href="" target="blank"
                                                   class="scrolla-element-anim-1" title="linkedin">
													<i class="fab fa-linkedin"></i>
												</a>
												<a href="" target="blank" class="scrolla-element-anim-1" title="twitter">
													<i class="fab fa-twitter"></i>
												</a>
												<a href="" target="blank" class="scrolla-element-anim-1"
                                                   title="facebook">
          ...
          <div class="lui-started v-line v-line-left">
    				<div class="section hero-started">
    					<div class="content scrolla-element-anim-1 scroll-animate" data-animate="active">
    						<div class="titles">
    							...
    							<h1 class="title splitting-text-anim-1 scroll-animate" data-splitting="chars" data-animate="active">
    								<span>
    									<b>Sibusiso</b> Ndlovu </span>
    							</h1>
    							<div class="label lui-subtitle"> I am <strong>Developer &
                                        Designer</strong>
    							</div>
    						</div>
    						<div class="description">
    							<div>
    								<p>With 16 years of programming  and website design experience under my belt, I
                                        have a wealth of knowledge and skills to bring to any project. I have a
                                        passion for building high-quality products, whether they be mobile apps,
                                        websites, or web applications.</p>
                                       <p class="mt-3"> Over the years, I've had the pleasure of working with a variety
                                           of clients,
                                    including businesses, individuals, and organizations. My strong problem-solving skills and love of business have helped me deliver successful projects time and time again.
                                           When I'm not coding, I enjoy spending time with my family and attending </p>
                                           church. <p class="mt-3">I believe in the importance of maintaining a
                                        healthy work-life
                                                       balance and prioritize time with loved ones whenever possible.
                                        I'm excited to bring my expertise and passion to your project and help bring your vision to life.</p>
    							</div>
    					...
    					<div class="slide scrolla-element-anim-1 scroll-animate" data-animate="active">
    						<img decoding="async" src="assets/images/software-developer-at-work.jpg" alt="Software Developer and
    						Website Designer at work in Pretoria" >
    						...
    						<div class="info-list">
    							<ul>
    								<li>
    									<span class="num">16 <strong>+</strong>
    									</span>
  						...
  						<div class="swiper-wrapper">
  							...
  							<div class="swiper-slide">
  								<div class="services-item">
  									...
  									<div class="icon"></div>
  									<h5 class="lui-title">
  										<span> Logo & Company Profile </span>
  									</h5>
  									<div class="lui-text">
